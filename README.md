## <a href="https://github.com/xunit/xunit"><img src="https://raw.github.com/xunit/media/master/full-logo.png" title="xUnit.net Xamarin Runners" /></a>
...
1.  Assembly containing tests. For this, install the following NuGet package: `Install-Package xunit -pre`
2.  App for running the tests on a device or simulator. For this, install `Install-Package xunit.runner.xamarin -pre`
